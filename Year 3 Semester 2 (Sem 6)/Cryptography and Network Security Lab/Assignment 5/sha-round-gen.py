...
def sigma_a(a):
    return circular_left_shift(a, 28, bit_size) ^ circular_left_shift(a, 34, bit_size) ^ circular_left_shift(a, 39, bit_size)


def sigma_e(e):
    return circular_left_shift(e, 14, bit_size) ^ circular_left_shift(e, 18, bit_size) ^ circular_left_shift(e, 41, bit_size)


def round(a, b, c, d, e, f, g, h, Wt, Kt):
    T1 = (h + ch(e, f, g) + sigma_e(e) + Wt + Kt) & (2 ** bit_size - 1)
    T2 = (sigma_a(a) + maj(a, b, c)) & (2 ** bit_size - 1)
    return (T1 + T2) & (2 ** bit_size - 1), a, b, c, (d + T1) & (2 ** bit_size - 1), e, f, g
