...
public class SlidingWindowGeneralClient {
    ...
    public SlidingWindowGeneralClient(InetAddress address, int port) throws SocketException {
        this.port = port;
    ...
    public static void main(String[] args) throws IOException {
        ...
        int port = 5000;
        SlidingWindowGeneralClient swgc = new SlidingWindowGeneralClient(address, port);
